...
public class LList_Test_Parametrized 
{
   ...
   //  EList arrayList = new AList1();
		...
		public LList_Test_Parametrized(EList ini)
		{
			arrayList= ini;
		}
		@Parameters
		...
		{
			Object [] [] data = new Object[][]{{new LList1()},{new LList2()},{new LList3()},};
		...
		@Test
		public void testToString_1_elem() 
		{
			int [] arrayTemp = {1};
			arrayList.init(arrayTemp);
			String arrayTemp2 =arrayList.toString();
