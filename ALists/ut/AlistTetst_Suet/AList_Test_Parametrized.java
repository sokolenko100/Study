...
public class AList_Test_Parametrized 
{
  ...
  //   EList arrayList = new AListR();
	EList arrayList =null;// new AList2();
		...
		{
			Object [] [] data = new Object[][]{{new AList0()},{new AList1()},{new AList2()},{new AListR()}};
...
/////////////////////////
	...
	public void testdelPos() 
	{
		...
		int [] arrayTemp3 =arrayList.toArray();
	...
	public void testaddPos_1_el() 
	{
		...
		int [] arrayTemp2 = {40,1};
		int [] arrayTemp4  = arrayList.toArray();
