...
import Alist_itterator.AList2_generic;
...
public class AList_Test_Parametrized 
{
	...
	//EList arrayList =null;// new AList2();
	 
	 
//		public AList_Test_Parametrized(EList ini)
//		{
//			arrayList= ini;
//		}
//		@Parameters
...
//		{
//			Object [] [] data = new Object[][]{{new AList1_generic<Integer>(Integer.class)},{new AList2_generic<Integer>(Integer.class)}};
...
/////////////////////////
	...
	public void testdelPos() 
	{
		...
		Integer [] arrayTemp3 =arrayList.toArray();
	...
	public void testaddPos_1_el() 
	{
		...
		Integer [] arrayTemp4  = arrayList.toArray();
		assertArrayEquals(arrayTemp2, arrayTemp4);
	}
	@Test
