...
public class PMainMenuBar  extends JMenuBar
{
	...
	public PMainMenuBar(PCommand cmd)
	{
		...
		menuItemLoad.addActionListener(cmd.actionOpen);
		menu.add(menuItemLoad);

		JMenuItem menuItemSave = new JMenuItem("Save",
		                         new ImageIcon("src/icon/bolt.png"));
			menuItemSave.addActionListener(cmd.actionSave);
		...
		//a menuColor
		menu.addSeparator();
		JMenuItem menuItemColorChooser = new JMenuItem("ColorChooser");
		menuItemColorChooser.addActionListener(cmd.aColor);
		
		menu.add(menuItemColorChooser);
		//a menuExit
		menu.addSeparator();
